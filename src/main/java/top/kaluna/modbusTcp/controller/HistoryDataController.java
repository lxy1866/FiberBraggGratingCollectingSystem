...
public class HistoryDataController {
    ...
    public CommonResp<List<String>> getHisX() throws IOException {
        ...
        List<String> list = readxlsxStr(getLastModified(path + "temperature").toString(),1,0);
    ...
    public CommonResp<List<Double>> getHisY() throws IOException {
        ...
        String path = txtFileConfig.getPath();
        List<Double> list = readxlsxVal(getLastModified(path + "temperature").toString(),0,0);
        resp.setContent(list);
        return resp;
    }
    ...
    public CommonResp<Map<String,List<Double>>> getStrainY() throws IOException {
        ...
        String path = txtFileConfig.getPath();
        List<Double> list1 = readxlsxVal(getLastModified(path + "strain").toString(),0,0);
        List<Double> list2 = readxlsxVal(getLastModified(path + "strain").toString(),1,0);
        List<Double> list3 = readxlsxVal(getLastModified(path + "strain").toString(),2,0);
        List<Double> list4 = readxlsxVal(getLastModified(path + "strain").toString(),3,0);
        List<Double> list5 = readxlsxVal(getLastModified(path + "strain").toString(),4,0);
        List<Double> list6 = readxlsxVal(getLastModified(path + "strain").toString(),5,0);
        List<Double> list7 = readxlsxVal(getLastModified(path + "strain").toString(),6,0);
        List<Double> list8 = readxlsxVal(getLastModified(path + "strain").toString(),7,0);
        List<Double> list9 = readxlsxVal(getLastModified(path + "strain").toString(),8,0);
        List<Double> list10 = readxlsxVal(getLastModified(path + "strain").toString(),9,0);
        List<Double> list11 = readxlsxVal(getLastModified(path + "strain").toString(),10,0);
        List<Double> list12 = readxlsxVal(getLastModified(path + "strain").toString(),11,0);
        List<Double> list13 = readxlsxVal(getLastModified(path + "strain").toString(),12,0);
    ...
    public CommonResp<List<String>> getShortTimeX() throws IOException {
        CommonResp<List<String>> resp = new CommonResp<>();
        List<String> list = readxlsxStr(txtFileConfig.getPath() +"shorttime.xlsx",1,0);
//        List<String> list = readxlsxStr("F:\\数据\\短时能量.xlsx",1,0);
    ...
    public CommonResp<List<Double>> getShortTimeY() throws IOException {
        CommonResp<List<Double>> resp = new CommonResp<>();
        List<Double> list = readxlsxVal(txtFileConfig.getPath() +"shorttime.xlsx",0,0);
//        List<Double> list = readxlsxVal("F:\\数据\\短时能量.xlsx",0,0);
    ...
    public CommonResp<List<String>> getVibrationX() throws IOException {
        CommonResp<List<String>> resp = new CommonResp<>();
        List<String> list = readxlsxStr(txtFileConfig.getPath() +"vibration.xlsx",1,0);
//        List<String> list = readxlsxStr("F:\\数据\\振动波长.xlsx",1,0);
    ...
    public CommonResp<List<Double>> getVibrationY() throws IOException {
        CommonResp<List<Double>> resp = new CommonResp<>();
        List<Double> list = readxlsxVal(txtFileConfig.getPath() +"vibration.xlsx",0,0);
