      ...
      <a-col :span="16">
        ...
        >
          ...
          <a-form-item
              label="电机3"
              name="loginName"
              :rules="[{ required: true, message: 'Please input your 电机3!' }]"
          >
            <a-input></a-input>
            <!--        <a-input v-model:value="LoginUser.loginName" />-->
          </a-form-item>
          ...
          <a-form-item
              label="电机4"
              name="password"
              :rules="[{ required: true, message: 'Please input your 电机4!' }]"
          >
            <a-input></a-input>
            <!--        <a-input-password v-model:value="LoginUser.password" />-->
          </a-form-item>
      ...
      <a-col :span="8">
        ...
        >
          <a-form-item :wrapper-col="{ offset: 8, span: 16 }">
            <a-button  html-type="submit" >设置</a-button>
          </a-form-item>
          <a-form-item :wrapper-col="{ offset: 8, span: 16 }">
            <a-button  html-type="submit" >特定形状</a-button>
          </a-form-item>
        </a-form>
      </a-col>
    </a-row>
