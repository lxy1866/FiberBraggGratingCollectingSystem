 ...
 */
@Component
@ServerEndpoint("/vibrationWaveWs/{token}")
public class WebSocketVibrationWaveServer {
    private static final Logger LOG = LoggerFactory.getLogger(WebSocketVibrationWaveServer.class);
