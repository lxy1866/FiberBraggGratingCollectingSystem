...
import top.kaluna.pipelineMonitor.config.parsetxtConfig.Delimiter;
...
public class UtahParserTxtUtil {
     ...
     * @return a parser
     */
    public static UtahParserTxtUtil parse(Config config, Reader in) {
        return new UtahParserTxtUtil(config, in);
    }
     ...
     * @param in     the input stream, the client is responsible for closing this
     */
    private UtahParserTxtUtil(Config config, Reader in) {
        this.config = config;
